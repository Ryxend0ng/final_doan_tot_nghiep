...
function register() {
    if (validationForm()) {
        ...
        $.ajax({
            ...
            error: function (e) {
                console.log("ERROR : "+"usr: "+ e.responseJSON.error.usrMsg+"|| devMsg: "+e.responseJSON.error.devMsg);
            }
        });
    }
}
...
function sendCodeConfirm() {
    ...
    if ($("#code-from-server").val() == $("#code-confirm").val()) {
        ...
        $.ajax({
            ...
            error: function (e) {
            console.log(e);
                console.log("ERROR : "+"usrMsg: "+ e.responseJSON.error.usrMsg+"|| devMsg: "+e.responseJSON.error.devMsg);
            }
        });
    } else {
