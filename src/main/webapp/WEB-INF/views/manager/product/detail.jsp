                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <div class="d-flex">
                                    <a href="${base}/ryxen-shop/admin/product.html" class="btn_back_list"><i
                                    ...
                                    <div class="bg-light p-4">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td> <img src="/user/upload/${product.avatar}" width="300" /></td>
                                            </tr>
                                            <tr>
                                                <td>Ngày tạo</td>
                                                <td>
                                                        ...
                                                        <c:forEach var="image" items="${product.productImages}">
                                                            <div class="col-sm-2 imgUp">
                                                                <img class="imagePreview image--product"
                                                                    src="/user/upload/${image.path}${image.title}" />
                                                            </div>
                                                        </c:forEach>
                                                    </div>
                                                </td>
