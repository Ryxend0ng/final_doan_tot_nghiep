                        ...
                        <div class="account-item clearfix js-item-menu">
                            <div class="image rounded-circle">
                                <c:if test="${userLogined.avatar!=null }">
                                    <img src="${base}/user/upload/${userLogined.avatar}" alt="${userLogined.fullname }" />
                                </c:if>
                                <c:if test="${userLogined.avatar==null }">
                            ...
                            <div class="account-dropdown js-dropdown rounded mt-2">
                                <div class="info clearfix">
                                    <div class="image rounded-circle">
                                        <a href="${base }/ryxen-shop/admin/my-account.html">
                                            <c:if test="${userLogined.avatar!=null }">
                                                <img src="${base}/user/upload/${userLogined.avatar}"
                                ...
                                <div class="account-dropdown__body">
                                    <div class="account-dropdown__item">
                                        <a href="${base}/ryxen-shop/trang-chu.html">
