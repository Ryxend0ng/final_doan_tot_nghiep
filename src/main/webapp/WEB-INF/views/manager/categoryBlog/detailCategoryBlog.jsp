                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <div class="d-flex">
                                    <a href="${base}/ryxen-shop/admin/category-blog.html" class="btn_back_list"><i class="fa fa-arrow-left"></i></a> &nbsp
                                ...
                                <div class="bg-light p-4">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="/user/upload/${category.avatar}" width="300" /></td>
                                        </tr>
                                        <tr>
                                            <td>Ngày tạo</td>
