                ...
                <div class="table-responsive" id="content-cart-page">
                    <c:if test="${cart==null}">
                        <div style="text-align:center">
                            ...
                            <a class="btn_1" href="${base }/ryxen-shop/product.html">Tiếp tục mua hàng</a>
                        </div>
                    </c:if>
                    <c:if test="${cart!=null}">
                        <table class="table">
                                ...
                                <c:forEach var="cartItem" items="${cart.cartItems}">
                                    <tr class="data-table" id="${cartItem.attrProductId }">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="d-flex">
                                                    <img src="/user/upload/${cartItem.avatarProduct}" alt="" width="150" />
                                                </div>
                                        ...
                                        <td>
                                            <h5 id="price">
                                            <input id="priceHidden" type="hidden" value="${cartItem.priceUnit}" />
