            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="${base }">
                        <img class="logo" src="${base }/user/img/my-logo/logoshop.PNG" alt="logo" width="84px"
                            height="60px" style="position: relative !important;">
                    </a>
                    ...
                    <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                        <ul class="navbar-nav stroke" id="mainNav">
                            <li class="nav-item my-menu-active" id="menu-home">
                                <a class="nav-link" href="${base}/ryxen-shop/trang-chu.html">Trang chủ</a>
                            </li>
                            <li class="nav-item" id="menu-product">
                                <a class="nav-link" href="${base}/ryxen-shop/san-pham.html">Sản phẩm</a>
                            </li>
                            <li class="nav-item " id="menu-blog">
                                <a class="nav-link" href="${base }/ryxen-shop/blog.html">Tin tức</a>
                            </li>
                            <li class="nav-item" id="menu-promotion">
                                <a class="nav-link" href="#">Khuyến mãi</a>
                            </li>
                            <li class="nav-item" id="menu-contact">
                                <a class="nav-link" href="${base }/ryxen-shop/contact.html">Liên hệ</a>
                            </li>
                            <li class="nav-item" id="menu-introduce">
                                <a class="nav-link" href="${base }/ryxen-shop/introduce.html">Giới thiệu</a>
                            </li>
                        </ul>
                    </div>
                    <div class="hearer_icon d-flex">
                        <div class="align-self-center cart" id="icon-cart-header">
                            <a class="text-center" href="${base }/ryxen-shop/cart.html">
                                ...
                                <div class="dropdown-toggle" id="navbarDropdown3" role="button" data-toggle="dropdown"
                                    ...
                                    <c:if test="${userLogined.avatar!=null }">
                                        <img width="35" height="35" class="rounded-circle"
                                            src="${base }/user/upload/${userLogined.avatar}" alt="">

                                    </c:if>
                                    <c:if test="${userLogined.avatar==null }">
                                        <img width="30" height="30" class="rounded-circle"
                                            src="${base}/user/upload/user/eee12.jpg" alt="">
                                    </c:if>
                                    &nbsp;
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown"
                                    ...
                                    <div class="p-2 rounded-5" id="menu-header-account">
                                        <div class="p-1 dropdown-menu-item menu-header-account-item">
                                            <a href="${base }/ryxen-shop/my-account.html"><i
                                        ...
                                        <div class="p-1 dropdown-menu-item menu-header-account-item">
                                            <a href="${base }/ryxen-shop/logout.html">
                        ...
                        <c:if test="${isLogined==false }">
                            <%--  <div id="login-item" style="margin-left: 30px; background: #ff443a; border-radius: 30px; padding: 10px; min-width: 100px; text-align: center;">
                                <a style=" color: #fff;" href="${base }/ryxen-shop/login.html">
                                    Đăng nhập
                                </a>
                            </div>
                             <div id="login-item" style="margin-left: 10px; background: #ff443a; border-radius: 30px; padding: 10px; min-width: 100px; text-align: center;">
                                <a style=" color: #fff;" href="${base }/ryxen-shop/register.html">
                                    Đăng ký
                                </a>
                            </div> --%>
                            <div class="dropdown ml-4">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown"
                                    ...
                                    <div class="p-2 rounded-5" id="menu-header-account">
                                        <div class="p-1 dropdown-menu-item menu-header-account-item">
                                            <a href="${base }/ryxen-shop/dang-nhap.html"><i class="fas fa-user-alt ml-0">
                                                    Đăng nhập</i></a>
                                        </div>
                                        <div class="p-1 dropdown-menu-item menu-header-account-item">
                                            <a href="${base }/ryxen-shop/dang-ky.html">
                                                <i class="fas fa-user-plus ml-0"> Đăng ký</i>
                                            </a>
                                        </div>
                                        <div class="p-1 dropdown-menu-item menu-header-account-item">
                                            <a href="${base }/ryxen-shop/search-order.html">
