$(document).ready(function () {
    ...
    $("body").on("change", ".btnChangeStatus", function (e) {
        ...
        $.post({
            url: "/ryxen-shop/admin/change-detail-category-blog",
            data: {
                status: status,
                id: id
            },
...
function loadCategory(keySearch, currentPage) {
    ...
    $.ajax({
        url: "/ryxen-shop/admin/all-category-blog",
        type: "get",
...
function detail(id) {
    window.location.href = '/ryxen-shop/admin/category-blog-detail/' + $('#view_' + id).val();
}

function edit(id) {
    window.location.href = '/ryxen-shop/admin/edit-category-blog/' + $('#edit_' + id).val();
}
...
function deleteConfirmed(idCategory) {
    ...
    $.post({
        url: '/ryxen-shop/admin/delete-category-blog',
        data: {
