...
function loadData() {
    ...
    $.get({
        url: "/ryxen-shop/admin/list-request-cancel-order",
        dataType: "json",
...
function deleteRequestConfirmed(idRequest) {
    ...
    $.post({
        url: "/ryxen-shop/admin/delete-request/" + idRequest,
        success: function (response) {
            if (response == true) {
...
function cancelOrderRequestConfirmed(idOrder, idRequest) {
    $.post({
        url: '/ryxen-shop/admin/cancel-order-request/' + idOrder,
...
function sentEmailConfirm(idOrder, status, content, idRequest) {
    $.ajax({
        url: '/ryxen-shop/admin/sent-email-confirm?idOrder=' + idOrder + '&&status=' + status + '&&content=' + content + "&&idRequest=" + idRequest,
        type: "POST",
        data: {},
        dataType: "json",
