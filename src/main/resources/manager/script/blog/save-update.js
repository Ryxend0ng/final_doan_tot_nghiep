        ...
        submitHandler: function (form1) {
            ...
            if (editor.getData() == "" || editor.getData() == null) {
                ...
                $.ajax({
                    ...
                    url: "/ryxen-shop/admin/add-update-blog",
                    data: data,
                    ...
                    success: function (data) {
                        ...
                        $(location).attr('href', "/ryxen-shop/admin/blog.html");
                    },
                    error: function (e) {
                        console.log("ERROR : ", e);
                    }
...
function loadDetailForEdit(idBlog) {
    $.ajax({
        url: "/ryxen-shop/admin/detail-blog",
        type: "get",
...
function loadCategory() {
    $.ajax({
        url: "/ryxen-shop/admin/all-category-blog-active",
        type: "get",
        contentType: "application/json", //set data send to server is json
        data: "",
        dataType: "json", //set data return is json
