$(document).ready(function () {
    ...
    $("body").on("change", ".btnChangeStatus", function (e) {
        ...
        $.post({
            url: "/ryxen-shop/admin/change-detail-blog",
            data: {
                status: status,
                id: id,
                type: type
...
function detail(id) {
    window.location.href = '/ryxen-shop/admin/blog-detail/' + $('#view_' + id).val();
}

function edit(id) {
    window.location.href = '/ryxen-shop/admin/edit-blog/' + $('#edit_' + id).val();
}
...
function deleteConfirmed(idBlog) {
    ...
    $.post({
        url: '/ryxen-shop/admin/delete-blog',
        type: "POST",
        data: {
            idBlog: idBlog
        },
