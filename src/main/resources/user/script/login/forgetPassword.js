...
function requestCode() {
    if (validationFormRequest()) {
        ...
        $.ajax({
            ...
            url: "/ryxen-shop/code-request-forget-password",
            data: {
                email: email
            },
            contentType: JSON,
...
function sendEmailCode() {
    ...
    $.ajax({
        type: "GET",
        enctype: 'multipart/form-data',
        url: "/ryxen-shop/send-email-code-confirm",
        data: {
            email: email
        },
        contentType: JSON,
    ...
    if (validationFormNewPass()) {
        ...
        if ($("#password").val() == $("#re-password").val()) {
            $.ajax({
                type: "GET",
                enctype: 'multipart/form-data',
                url: "/ryxen-shop/change-password-forget",
                data: {
                    email: email,
                    password: password
                },
                ...
                success: function (jsonResult) {
                    ...
                    window.location.href = '/ryxen-shop/login.html';
                },
                error: function (e) {
                    console.log("ERROR : ", e);
                }
