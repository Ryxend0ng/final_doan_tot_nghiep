$(document).ready(function () {
    ...
    $("body").on("click", "#buyNow", function () {
        ...
        if (maxOrder == 0) {
            ...
            window.location.href = '/ryxen-shop/bill?idAttr=' + idAttr + "&&amount=" + amount;
        }
    });
    ...
    $("#formReview").validate({
        ...
        submitHandler: function (form) {
            ...
            $("#errMsgReview").html('');
            $.post({
                url: '/ryxen-shop/reviews-product',
...
function loadData() {
    ...
    $.get({
        url: "/ryxen-shop/detail-product-loading",
        data: {
        ...
        success: function (jsonResult) {
            ...
            image_slide += '	<img class="d-block mw-100" src="/user/upload/' +
            ...
            if (jsonResult.product.images != null) {
                ...
                $.each(jsonResult.product.images, function (key, value) {
                    ...
                    image_slide +=
                        '	<img class="d-block mw-100 mx-auto" style="max-height:600px" src="/user/upload/' +
                        ...
                        <div class="review_item px-5">
                            <div class="media">
                                <div class="d-flex">
                                    ...
                                    src="${(review.user == null) ? '/user/img/no-avatar.png' : '/user/upload/'+review.user.avatar}" 
                                    alt="" />
                                </div>
    ...
    $.ajax({
        ...
        success: function (jsonResult) {
            ...
            $.each(jsonResult, function (index, value) {
                ...
                html += '     <img class="img-product" src="/user/upload/' + value.avatar + '" alt="' +
                    value.title + '">';
