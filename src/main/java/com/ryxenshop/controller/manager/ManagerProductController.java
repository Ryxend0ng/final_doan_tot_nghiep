...
import com.ryxenshop.dto.ProductDTO;
...
public class ManagerProductController extends BaseController {
	...
	public ResponseEntity<Product> detailProduct(@PathVariable Integer id) throws Exception {
	...
	public ResponseEntity<Boolean> changeDetail(HttpServletRequest request) throws Exception {
		...
		Product product = productService.findById(Integer.valueOf(request.getParameter("id")));
		if (product == null) {
