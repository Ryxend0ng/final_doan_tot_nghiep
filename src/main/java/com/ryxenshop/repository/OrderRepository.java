...
public interface OrderRepository extends JpaRepository<Order, Integer>, JpaSpecificationExecutor<Order> {
	...
	@Query("SELECT new com.ryxenshop.valueObjects.RevenueDate(o.createdDate ,SUM(o.total)) FROM Order o WHERE o.createdDate >= ?1 "
	...
	@Query("SELECT new com.ryxenshop.valueObjects.RevenueVo(o.createdDate, COUNT(o.id), "
	...
	@Query("SELECT new com.ryxenshop.valueObjects.BestSaleProductVo(p.avatar, p.title, SUM(d.quantity), SUM(d.price)) "
	...
	@Query("SELECT new com.ryxenshop.valueObjects.OrderStatistical(COUNT(CASE WHEN o.processingStatus = 3 THEN o.id ELSE null END),"
